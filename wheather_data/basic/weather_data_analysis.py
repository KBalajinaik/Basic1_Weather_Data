...
# Check if 'Date' column exists before proceeding with date-related operations
if 'Date' in df.columns:
    print("Date column found. Proceeding with date-related analysis...")
    ...
    print("Date column is not present in the dataset. Skipping date-related analysis.")
